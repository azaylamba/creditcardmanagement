...
You have to design & build the backend for the application and the ability for the users to register, add cards and manage transactions.
...
https://github.com/azaylamba/creditcardmanagement 
